...
The released version of _Dyn4cast_ can be installed from [CRAN](https://cran.r-project.org/web/packages/Dyn4cast/index.html). Therefore, only the development version is currently running. The canonical form for  [CRAN](https://cran.r-project.org/web/packages/Dyn4cast/index.html) is:
...
8. `mdi` is for computation of multidimensional indicators and indices  

8. `plot_mdi` is to plot the indices
