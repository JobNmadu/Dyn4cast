...
2. `constrained_forecast` which constrain forecast of one-sided integer forecast to lie between the lower and upper limits of the base data. The function estimates the lower and upper 80% and 95% forecasts of the estimated model. This function works with two other fuctions, that is, `inv_scaled_ligit` and `scaled_logit` which are adapted from Hyndman & Athanasopoulos (2021) and both of which are adopted.
