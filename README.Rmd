...
The package is capable of computing, estimating, predicting and forecasting of the following models.  
...
This is a basic example of the `DynamicForecast` function, which shows you how to solve a common problem:
