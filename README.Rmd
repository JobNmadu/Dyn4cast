...
[![codecov test coverage](https://codecov.io/gh/JobNmadu/Dyn4cast/graph/badge.svg)](https://codecov.io/gh/JobNmadu/Dyn4cast)
...
Although not a dependency, the package derives functionally from a number of other packages and so may require you to install such packages if they are not yet installed. Some of the packages are listed below:
