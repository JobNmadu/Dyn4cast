...
#'
#' There are excellent materials dealing with each of the treatment effects, please see [Understanding propensity score weighting](https://livefreeordichotomize.com/posts/2019-01-17-understanding-propensity-score-weighting/)
#'
