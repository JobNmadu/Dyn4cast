...
Deprecation list introduced. It is now possible to specify the number of digits in `quicksummary`. The flow of the output in `quicksummary` summary is more logical nw.
